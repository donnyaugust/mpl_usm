        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-dark" style="color: #fd6701;" href="<?= BASEURL; ?>cont/about"><b>About</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-dark" style="color: #fd6701;" href="<?= BASEURL; ?>cont/activity"><b>Activity</b></a>
                    </li>
                    <li class="nav-item">
